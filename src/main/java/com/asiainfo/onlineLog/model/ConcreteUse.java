...
public class ConcreteUse {
    ...
    public ConcreteUse(String busiId, String groupCount, float aliasFlow, String appExtFlag, String maxTime, String minTime, String termModel, String termModelCode) {
        this.busiId = busiId;
    ...
    public float getAliasFlow() {
        return aliasFlow;
    }

    public void setAliasFlow(float aliasFlow) {
        this.aliasFlow = aliasFlow;
    }
